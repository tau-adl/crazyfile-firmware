...
PLATFORM_HELP_cf2b =Crazyflie2 platform, includes Crazyflie 2.0, Crazyflie 2.1  with blimp modifications
PLATFORM_NAME_cf2b = CF2 platform with blimp modifications
...
######## special configuration for blimp code ########3

## CFLAGS += -DDEVICE_TYPE_BLIMP_MODIFICATION